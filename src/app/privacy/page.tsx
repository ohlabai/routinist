...
const SECTIONS_EN: { title: string; items: string[] }[] = [
  { title: '1. Information We Collect', items: [
    'Account info: email, nickname, profile photo',
    'Running records: distance, duration, date, GPS route data',
    'Health data: workout data via Apple Health / Health Connect (only with user consent)',
    'Location: real-time GPS during tracking; residence district for regional ranking',
    'Social info: friend connections, club memberships, comments, direct messages',
    'Transaction info: mileage earn/use history, shop orders, shipping details',
  ]},
  { title: '2. Purpose of Use', items: [
    'Manage running records and provide statistics',
    'Provide regional rankings and club leaderboards',
    'Display running routes and heatmap on the map',
    'Enable social features (friends, comments, cheers, messages)',
    'Mileage accrual and shop services',
    'Service improvement and personalization',
  ]},
  { title: '3. Sharing of Information', items: [
    'Public profile: nickname, photo, and lifetime stats may be visible to other users',
    'Running distance and rank are shared with club members',
    'You can set visibility per activity (public / private)',
    'Direct messages are visible only to sender and recipient',
    'We do not sell or share personal data with third parties',
  ]},
  { title: '4. Health Data', items: [
    'Data read via Apple Health / Health Connect: workout sessions, distance traveled',
    'Health data is used solely for syncing running records',
    'Health data is not shared with third parties',
    'You can revoke access at any time',
  ]},
  { title: '5. Location Information', items: [
    'Real-time location is collected during GPS tracking',
    'Location data is used for running route recording and map display',
    'You can set a privacy zone to hide routes near home',
    'You can disable location collection in app settings',
  ]},
  { title: '6. Mileage and Payments', items: [
    'Mileage is auto-credited based on running distance (1km = 10P)',
    'Mileage ledger is transparent and viewable by the user',
    'Payments are processed securely by PG providers; card numbers are not stored on our servers',
  ]},
  { title: '7. Block and Report', items: [
    'You can block unwanted users to limit messages and friendships',
    'You can report inappropriate content or behavior',
  ]},
  { title: '8. Retention and Deletion', items: [
    'Data is stored encrypted in the cloud',
    'On user request, all data is deleted within 30 days',
    'On account deletion, all running records, profile, and messages are deleted',
  ]},
  { title: '9. Contact', items: [
    'Privacy inquiries: routinist@openhan.kr',
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-emerald-50/40">
      <div className="max-w-lg mx-auto px-4 py-6 space-y-6 pb-8">
        <div className="flex items-center gap-3 pt-[env(safe-area-inset-top)]">
          ...
          <h1 className="text-xl font-bold text-[var(--foreground)]">{isEn ? 'Privacy Policy' : '개인정보처리방침'}</h1>
        </div>

        <p className="text-xs text-[var(--muted)]">{isEn ? 'Effective date: April 13, 2026' : '시행일: 2026년 4월 13일'}</p>
