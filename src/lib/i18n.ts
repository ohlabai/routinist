...
'전체 대화 보기': 'View full chat',
'받은 응원': 'cheers',
'이번 주 함께 달리기': 'This week, side by side',
'최근 러닝': 'Recent runs',
'아직 나눈 대화가 없어요. 한마디로 응원해 보세요!': 'No messages yet — send a word of cheer!',
'응원 한마디 보내기…': 'Send a cheer…',
'메시지를 못 보냈어요. 잠시 후 다시 시도해 주세요': "Couldn't send. Please try again",
...
'월말 결산': 'Month-end recap',
  ...
  '일시정지 중': 'Paused',
  '회 러닝': ' runs',
  // ── 2026-08-02 i18n 잔여 스윕 (누락 37키 — 조앤·Gachaman 등 영문 유저 표면) ──
  '거리 × 페이스': 'Distance × Pace',
  '거절': 'Decline',
  '걷기': 'Walk',
  '관심있는 상품을 담아보세요': 'Save items you like',
  '권한이 없어요. 다시 로그인해보세요': 'No permission — try signing in again',
  '답글 저장': 'Save reply',
  '답글 저장 실패: ': 'Failed to save reply: ',
  '답글이 저장됐어요': 'Reply saved',
  '더 보기': 'See more',
  '불러오는 중...': 'Loading...',
  '사용자에게 답변을 작성해주세요': 'Write a reply to the user',
  '새 친구': 'New friend',
  '쇼핑하러 가기': 'Go shopping',
  '수락': 'Accept',
  '신청 보냄 · 탭하면 취소': 'Request sent · tap to cancel',
  '심박 영역': 'Heart rate zones',
  '심박 추이': 'Heart rate trend',
  '심박 영역 분석': 'HR zone analysis',
  '평균 심박': 'Avg HR',
  '아직 알림이 없어요': 'No notifications yet',
  '알림': 'Notifications',
  '예상 레이스 기록': 'Race predictions',
  '요일 패턴': 'Weekly rhythm',
  '운영자 답글 작성': 'Write an admin reply',
  '응원': 'Cheer',
  '응원·댓글·친구 추가가 오면 여기서 확인할 수 있어요': 'Cheers, comments and new friends show up here',
  '이달의 페이스메이커': "This month's pacemaker",
  '이전 러닝 정리하기': 'Clean up previous run',
  '일시정지': 'Pause',
  '자동 일시정지': 'Auto-paused',
  '주간 훈련량': 'Weekly training load',
  '최근 30일': 'Last 30 days',
  '최근 30일 러닝 경로': 'Routes · last 30 days',
  '친구 신청·수락': 'Friend requests',
  '친구 신청을 보냈어요 💌': 'Friend request sent 💌',
