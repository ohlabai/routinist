...
export const PUBLIC_PROFILE_FIELDS =
  'id, display_name, avatar_url, bio, region_si, region_gu, region_dong, is_public, total_distance_km, total_runs, total_duration_seconds, country_code, running_since, gender, show_gender, created_at, updated_at, onboarded_at';
