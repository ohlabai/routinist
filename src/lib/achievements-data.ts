...
export const ACHIEVEMENTS: Record<string, AchievementDef> = {
  ...
  first_course: { code: 'first_course', name: '월드런 첫 완주', description: '월드런 첫 코스 완주', emoji: '🌍', category: 'course' },
  courses_3: { code: 'courses_3', name: '3 코스 완주', description: '월드런 3개 완주', emoji: '🎖️', category: 'course' },
  courses_10: { code: 'courses_10', name: '10 코스 마스터', description: '월드런 10개 완주', emoji: '🌟', category: 'course' },
